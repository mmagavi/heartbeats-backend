...
public class GenerateExercise extends GeneratePlaylist {
     ...
     */
    private final HeartRateRange targetRangeBPM;
     ...
     */
    private final HeartRateRange[] startTargetBPMs;
    /**
     ...
     */
    private final HeartRateRange[] endTargetBPMs;
    ...
    public GenerateExercise(int age, int restBPM, boolean isQuickStart, boolean isQuickEnd, int lenPlaylist,
        ...
        this.targetRangeBPM = DesiredHeartRateRanges.getHeartRateRange(Math.abs(age));
     ...
     */
    private HeartRateRange[] getTargetTransitions(boolean isStart, boolean isQuick) {
        int numIntervals;
        ...
        for (int i = 0; i < numIntervals; i++){
            ...
            HeartRateRange currBPM = DesiredHeartRateRanges.toHeartRateRange(currTarget, offset);
    ...
    private void constructPlaylist() throws CreatePlaylistException, AddItemsToPlaylistException, GetCurrentUsersProfileException {
        ...
        for (HeartRateRange endBPM: this.endTargetBPMs) {
