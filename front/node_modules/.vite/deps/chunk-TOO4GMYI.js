...
var BadgeUnstyled = React37.forwardRef(function BadgeUnstyled2(props, ref) {
  const {
    component,
    children,
    max: maxProp = 99,
...
var ButtonUnstyled = React39.forwardRef(function ButtonUnstyled2(props, forwardedRef) {
  var _ref;
  const {
    action,
    children,
...
var FormControlUnstyledContext = React40.createContext(void 0);
if (true) {
...
var FormControlUnstyled = React41.forwardRef(function FormControlUnstyled2(props, ref) {
  var _ref;
  const {
    defaultValue,
    children,
...
function useFormControlUnstyledContext() {
  return React42.useContext(FormControlUnstyledContext_default);
}
...
var InputUnstyled = React44.forwardRef(function InputUnstyled2(props, forwardedRef) {
...
function useSelectChangeNotifiers() {
  ...
  const notifySelectionChanged = React46.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React46.useCallback((newHighlightedItem) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC, newHighlightedItem);
  }, [messageBus]);
  const registerSelectionChangeHandler = React46.useCallback((handler) => {
...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React47.useRef(initialState);
  React47.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React47.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const reducerWithControlledState = React47.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    return reducer(controlledState, action);
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React47.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React47.useCallback((action) => {
...
function useForcedRerendering() {
  const [, setState] = React51.useState({});
...
function useListItem(parameters) {
  ...
  const createHandleClick = React53.useCallback((other) => (event) => {
    var _other$onClick;
  ...
  const createHandlePointerOver = React53.useCallback((other) => (event) => {
...
function useCompoundParent() {
  ...
  const registerItem = React54.useCallback(function registerItem2(id, item, missingKeyGenerator) {
...
function useMenu(parameters = {}) {
  ...
  const stateChangeHandler = React55.useCallback((event, field, fieldValue, reason, state) => {
    if (field === "open") {
...
var MenuUnstyled = React57.forwardRef(function MenuUnstyled2(props, forwardedRef) {
...
var MenuItemUnstyled = React60.forwardRef(function MenuItemUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    disabled: disabledProp = false,
...
var OptionGroupUnstyled = React61.forwardRef(function OptionGroupUnstyled2(props, ref) {
  const {
    component,
    disabled = false,
    slotProps = {},
...
var SelectUnstyled = React66.forwardRef(function SelectUnstyled2(props, forwardedRef) {
...
var SliderUnstyled = React67.forwardRef(function SliderUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime40.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime39.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime39.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime40.jsxs)(React67.Fragment, {
...
var SnackbarUnstyled = React68.forwardRef(function SnackbarUnstyled2(props, ref) {
  const {
    autoHideDuration = null,
    children,
    component,
...
var TablePaginationActionsUnstyled = React71.forwardRef(function TablePaginationActionsUnstyled2(props, ref) {
...
var TablePaginationUnstyled = React72.forwardRef(function TablePaginationUnstyled2(props, ref) {
...
var Context = React74.createContext(null);
if (true) {
...
var TabsUnstyled = React76.forwardRef(function TabsUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    orientation = "horizontal",
...
var TabPanelUnstyled = React77.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
var TabsListUnstyled = React80.forwardRef(function TabsListUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
var TabUnstyled = React82.forwardRef(function TabUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    disabled = false,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TOO4GMYI.js.map
